...
// User management
router.get('/users/search', (req, res) => adminController.searchUsers(req, res));
...
router.put('/users/:id/promote', (req, res) => adminController.promoteUser(req, res));
router.put('/users/:id/demote', (req, res) => adminController.demoteUser(req, res));
...
router.post('/groups/:id/members', (req, res) => adminController.addGroupMember(req, res));
router.delete('/groups/:id/members/:userId', (req, res) => adminController.removeGroupMember(req, res));
