...
export const Settings = () => {
  ...
  // Form states
  const [serverKeyForm, setServerKeyForm] = useState({ provider: 'deepl', name: '', apiKey: '' });
  ...
  const handleAddServerKey = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setServerKeyForm({ provider: 'deepl', name: '', apiKey: '' });
              ...
              <form onSubmit={handleAddServerKey} className="mb-6 p-4 bg-neutral-50 rounded-lg border border-neutral-200 space-y-3">
                <div className="grid grid-cols-3 gap-3">
                  <div>
                    ...
                    <select value={serverKeyForm.provider} onChange={(e) => setServerKeyForm({ ...serverKeyForm, provider: e.target.value })} className="input-base">
